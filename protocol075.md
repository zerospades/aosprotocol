...
querying the support for client and server functionality. Each extension is given
a unique id when it is first registered, and is negotiated with the `ExtInfo`
packet (id 60).
...
| 3    | [Extended Spawn Packet](extensions/extended-spawn-packet.md) | `HAS_PACKETS` | Extra per-player properties on spawn, such as leaving a player out of the presentation |
